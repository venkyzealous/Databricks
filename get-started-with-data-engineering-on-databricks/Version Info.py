...
# MAGIC
# MAGIC * Name: **Get Started with Data Engineering on Databricks**
# MAGIC * Version:  **2.0.3**
# MAGIC * Built On: **Sep 27, 2023 at 14:18:18 UTC**
...
# MAGIC
# MAGIC This course is tested against and requires one of the following DBRs (Databricks Runtime): **13.2.x-scala2.12, 13.2.x-photon-scala2.12, 13.2.x-cpu-ml-scala2.12**.
# MAGIC
