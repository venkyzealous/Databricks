...
course_config = CourseConfig(course_code = "gswdeod",
                             ...
                             supported_dbrs = ["13.3.x-photon-scala2.12","13.3.x-scala2.12","13.2.x-scala2.12", "13.2.x-photon-scala2.12", "13.2.x-cpu-ml-scala2.12"],
                             expected_dbrs = "13.3.x-photon-scala2.12,13.3.x-scala2.12,13.2.x-scala2.12, 13.2.x-photon-scala2.12, 13.2.x-cpu-ml-scala2.12")
